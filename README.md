...
Berlin, Germany  
[arumarwaha@gmail.com](arumarwaha@gmail.com) | [LinkedIn](https://www.linkedin.com/in/arunimarwaha/) |[GitHub](https://github.com/arunimarwaha)

## Technical Skills
**Programming & Data Tools:** Python, R, SQL, STATA, Excel, Git, LaTeX 

**Python/R Libraries:** pandas, NumPy, scikit-learn, matplotlib, seaborn, tidyverse, ggplot2, dplyr, tidyr, readr, lubridate, caret, randomForest, gbm
...
**Research Assistant -- Data Structuring & Fiscal Analysis @ Jacques Delors Centre, Hertie School (_Jun 2025 – Sep 2025_)**
...
- Compared 6 housing-price prediction models on 506 observations, improving predictive performance by 26% using random forests versus a single regression tree.

### Melbourne Housing Market Analysis & Price Modelling
[GitHub Repository](https://github.com/arunimarwaha/melbourne-housing-analysis)

- Conducted end-to-end housing market analysis using R, including data cleaning, exploratory analysis, predictive modeling, and visualization to evaluate factors influencing residential property prices.
  
- Applied regression and classification methods to forecast housing values and identify high-value properties, demonstrating statistical modeling, feature analysis, and data storytelling skills.
...
- Built a weighted state-year labour market dataset from 3M+ observations to track women’s share in government jobs.
